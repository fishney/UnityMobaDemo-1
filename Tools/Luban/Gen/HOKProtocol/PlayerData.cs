...
namespace proto.HOKProtocol
{
    ...
    public  sealed class PlayerData :  Bright.Serialization.BeanBase 
    {
        ...
        public PlayerData(Bright.Common.NotNullInitialization _) 
        {
            ...
            bagData = new System.Collections.Generic.List<HOKProtocol.BagItemData>();
        }
        ...
        public static PlayerData DeserializePlayerData(ByteBuf _buf)
        {
         ...
         public System.Collections.Generic.List<HOKProtocol.BagItemData> bagData;
        ...
        public override void Serialize(ByteBuf _buf)
        {
            ...
            { _buf.WriteSize(bagData.Count); foreach(var _e in bagData) { HOKProtocol.BagItemData.SerializeBagItemData(_buf, _e); } }
        }
        ...
        public override void Deserialize(ByteBuf _buf)
        {
            ...
            {int n = System.Math.Min(_buf.ReadSize(), _buf.Size);bagData = new System.Collections.Generic.List<HOKProtocol.BagItemData>(n);for(var i = 0 ; i < n ; i++) { HOKProtocol.BagItemData _e;  _e = HOKProtocol.BagItemData.DeserializeBagItemData(_buf); bagData.Add(_e);}}
        }
        ...
        public override string ToString()
        {
            ...
            + "bagData:" + Bright.Common.StringUtil.CollectionToString(bagData) + ","
            + "}";
        }
    }
